...
- [RES-Labo-05-HTTP](#res-labo-05-http)
	...
	- [Step 2: Dynamic HTTP server with express.js](#step-2-dynamic-http-server-with-expressjs)
		...
		- [démarrer les conteneurs](#démarrer-les-conteneurs)
		- [Mauvaise idée de configurer un site comme cela](#mauvaise-idée-de-configurer-un-site-comme-cela)
	- [Step 4: AJAX requests with JQuery](#step-4-ajax-requests-with-jquery)
		- [construire les images docker depuis la racine 1](#construire-les-images-docker-depuis-la-racine-1)
		- [demarrer les conteneur](#demarrer-les-conteneur)
	- [Step 5: Dynamic reverse proxy configuration](#step-5-dynamic-reverse-proxy-configuration)
		- [construire les images docker depuis la racine 2](#construire-les-images-docker-depuis-la-racine-2)
	...
	- [Additional Setps : Load balancing multiple server nodes](#additional-setps--load-balancing-multiple-server-nodes)
		- [construire les images docker depuis la racine 3](#construire-les-images-docker-depuis-la-racine-3)
		- [démarrer les conteneur dynamic et static](#démarrer-les-conteneur-dynamic-et-static)
		- [démarrer le conteneur reverse-proxy](#démarrer-le-conteneur-reverse-proxy)
...
### construire les images docker depuis la racine 1
...
### construire les images docker depuis la racine 2
...
### construire les images docker depuis la racine 3
